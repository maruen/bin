...
then
	echo "The IP of $1 has changed from ${PREVIOUS_IP} to ${CUR_IP}"
	echo "Uploading the new hosts file to root@96.126.114.91:/etc/hosts"	
	REPLACE_HOSTS=`scp ${CUR_DIR}/hosts root@96.126.114.91:/etc/hosts`
else
	echo "There was no changing of IP, nothing done!"	
fi
